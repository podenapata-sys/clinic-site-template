/* Highlight the brand name "Example Land Survey" / "উদাহরণ ল্যান্ড সার্ভে" in running text.
...
(function () {
  ...
  var RXG = /(Example Land Survey|উদাহরণ ল্যান্ড সার্ভে[ঀ-৿]*)/g;
  var RXT = /(Example Land Survey|উদাহরণ ল্যান্ড সার্ভে)/;
